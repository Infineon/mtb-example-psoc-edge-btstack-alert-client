...
The following example clones the "[Alert-Client](https://github.com/Infineon/mtb-example-psoc-edge-btstack-alert-client)" application with the desired name "AlertClient" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-btstack-alert-client --user-app-name AlertClient --target-dir "C:/mtb_projects"
   ```
